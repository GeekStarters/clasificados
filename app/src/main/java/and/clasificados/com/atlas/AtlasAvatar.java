...
import and.clasificados.com.atlas.util.Util;
import and.clasificados.com.atlas.util.picasso.transformations.CircleTransform;
...
public class AtlasAvatar extends View {
    ...
    public AtlasAvatar init(ParticipantProvider participantProvider, Picasso picasso) {
        ...
        mPaintBackground.setColor(getResources().getColor(and.clasificados.com.R.color.atlas_avatar_background));
        mPaintBorder.setColor(getResources().getColor(and.clasificados.com.R.color.atlas_avatar_border));
        mPaintInitials.setColor(getResources().getColor(and.clasificados.com.R.color.atlas_avatar_text));
