package and.clasificados.com.atlas.messagetypes.threepartimage;
...
import and.clasificados.com.atlas.messagetypes.AtlasCellFactory;
...
import and.clasificados.com.atlas.util.imagepopup.AtlasImagePopupActivity;
import and.clasificados.com.atlas.util.picasso.transformations.RoundedTransform;
...
public class ThreePartImageCellFactory extends AtlasCellFactory<ThreePartImageCellFactory.CellHolder, ThreePartImageCellFactory.Info> implements View.OnClickListener {
    ...
    public ThreePartImageCellFactory(Activity activity, LayerClient layerClient, Picasso picasso) {
        ...
        mPicasso = picasso;
        float radius = activity.getResources().getDimension(R.dimen.atlas_message_item_cell_radius);
    ...
    public static class Info implements ParsedContent, Parcelable {
