...
import and.clasificados.com.auxiliares.CustomPhotoGallery;
...
public class Publicar_alt extends AppCompatActivity implements IListDialogListener,AdapterView.OnItemSelectedListener {
    ...
    private ArrayList<String> encoded, name, imagesPathList;
    Uri file;
    File f;
    String nombre=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_user= PrefUtils.getCurrentUser(Publicar_alt.this);
                ...
                switch (v.getId()){
                    ...
                    case R.id.camera:
                       if(num>=6){
                        ...
                        break;
                    case R.id.gallery:
                        intent = new Intent(Publicar_alt.this,CustomPhotoGallery.class);
    ...
    protected void showShareDialog() {
        LayoutInflater layoutInflater = LayoutInflater.from(Publicar_alt.this);
        View promptView = layoutInflater.inflate(R.layout.share_dialog, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Publicar_alt.this);
