...
import and.clasificados.com.atlas.messagetypes.AttachmentSender;
import and.clasificados.com.atlas.messagetypes.MessageSender;
import and.clasificados.com.atlas.messagetypes.text.TextSender;
...
public class AtlasMessageComposer extends FrameLayout {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<AtlasMessageComposer.SavedState>() {
            public AtlasMessageComposer.SavedState createFromParcel(Parcel in) {
                return new AtlasMessageComposer.SavedState(in);
            }

            public AtlasMessageComposer.SavedState[] newArray(int size) {
                return new AtlasMessageComposer.SavedState[size];
            }
        };
